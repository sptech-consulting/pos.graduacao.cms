...
- Wave 4 in progress: `ambiente.functions.ts` migrated to backend API wrapper (`ambiente.api.ts`).
...
3. Migrate next P1/P2 files (`aluno.functions.ts`) to backend aluno/auth endpoints.
